...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.01, -- MAM EDIT, how much foreign investment money counts towards your industry score
...
pops = {
	...
	ASSIMILATION_SCALE = 0.001, -- MAM EDIT
